...
class MeshingParameters():
    ...
    def method(self, value):
        ...
        self._method = validade_parameter("method", value, allowed_types)
    ...
    def mesh_type(self, value):
        ...
        if value is not None and value not in allowed_types:
            validade_parameter("mesh_type", value, allowed_types)
    ...
    def padding_type(self, value):
        ...
        if value not in allowed_types:
            validade_parameter("padding_type", value, allowed_types)
    ...
    def winslow_implementation(self, value):
        ...
        if value is not None and value not in allowed_types:
            validade_parameter("winslow_implementation", value, allowed_types)
