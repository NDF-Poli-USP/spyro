...
class HABC_Damping():
    ...
    #     validade_parameter("type_CR", type_CR, ["CR_PSI", "CR_FEM", "CR_ERR"])
    ...
    #             """
    #             validade_parameter("ele_type", ele_type, ["lumped", "consistent"])
    ...
    #     real_roots = [r.real for r in roots_values if isreal(r)]
