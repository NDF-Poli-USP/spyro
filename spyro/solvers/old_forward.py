...
def old_forward(
    ...
    mesh = wave_object.mesh
    comm = wave_object.comm
    c = wave_object.c
    wavelet = wave_object.wavelet
    ...
    lx = wave_object.abc_pad_length
    lz = wave_object.abc_pad_length
    x1 = 0.0
    x2 = Lx
    a_pml = lx
    z1 = 0.0
    ...
    # cmax = model["cmax"]  # maximum acoustic wave velocity
    # R = model["R"]  # theoretical reclection coefficient
    ps = wave_object.abc_exponent
    cmax = wave_object.abc_cmax
    R = wave_object.abc_R
    pml_dict = {
        "exponent": ps,
        "cmax": cmax,
