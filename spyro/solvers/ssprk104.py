...
def SSPRK104(model, mesh, comm, c, excitations, receivers, source_num=0, output = True):
    ...
    # create output files
    outfile = helpers.create_output_file("SSPRK104_withLSource.pvd", comm, source_num)
