...
from .acoustic_solver_construction_no_pml_jessica import (
    construct_solver_or_matrix_no_pml_jessica,
)
...
class AcousticWaveJessica(Wave):
    ...
    def matrix_building(self):
        ...
        if abc_type is None or abc_type == "hybrid":
            construct_solver_or_matrix_no_pml_jesica(self)
        elif abc_type == "PML":
