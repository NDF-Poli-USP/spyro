...
from . import helpers
from ..tools import min_equilateral_distance
import sys
import time
...
def forward_elastic_waves_AD(
    ...
    **kwargs
    ...
    # h_min = min_equilateral_distance(mesh, V, rec_loc)
    ...
    J0            = 0.0
    interpolator, P = receivers.vertex_only_mesh_interpolator(u_nm1, elastic=True)
    ...
    for step in range(nt):
        ...
        f = excitations.apply_radial_source(f, wavelet[step]/(0.1*0.1))
