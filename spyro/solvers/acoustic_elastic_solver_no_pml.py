...
def construct_acoustic_elastic(Wave_obj):
    ...
    # p_t, p_v = TrialFunction(Wave_obj.scalar_function_space), TestFunction(
    #     Wave_obj.scalar_function_space
    # )
    # u_t, u_v = TrialFunction(Wave_obj.vector_function_space), TestFunction(
    #     Wave_obj.vector_function_space
    # )

    # M_p_mat = assemble(
    #     p_t * p_v * dx(**Wave_obj.quadrature_rule_fluid), mat_type="aij"
    # ).petscmat
    # M_u_mat = assemble(
    #     dot(u_t, u_v) * dx(**Wave_obj.quadrature_rule_solid), mat_type="aij"
    # ).petscmat
