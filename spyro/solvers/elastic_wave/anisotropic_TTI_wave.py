...
from .forms import (elastic_without_pml, viscoelastic_without_pml, elastic_with_pml, viscoelastic_with_pml)
...
VISCOELASTIC_PARAMETERS = (
    ViscoelasticMaterialParameter.Q_VP,
    ViscoelasticMaterialParameter.Q_VS,
    ViscoelasticMaterialParameter.Q_GAMMA,
    ViscoelasticMaterialParameter.Q_DELTA,
...
ANISOTROPIC_PARAMETERS = (
    ...
    AnisotropicMaterialParameter.THETA,
    AnisotropicMaterialParameter.PHI,
)
...
class AnisotropicTTIWave(IsotropicWave):
    ...
    def __init__(self, dictionary, comm=None):
        ...
        self.wave_type = WaveType.ANISOTROPIC_TTI_ELASTIC
    ...
    def set_physical_parameterization(
        ...
        self.theta = as_function(
            self.theta, AnisotropicMaterialParameter.THETA,
        )
        self.phi = as_function(
            self.phi, AnisotropicMaterialParameter.PHI,
        )
        ...
        add(AnisotropicMaterialParameter.THETA, self.theta)
        if self.phi is not None:
            add(AnisotropicMaterialParameter.PHI, self.phi)
