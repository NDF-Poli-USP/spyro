...
def create_model_for_grid_point_calculation(frequency, degree, method, minimum_mesh_velocity, experiment_type = 'homogeneous', receiver_type = 'near', dimension = 2):
    ...
    if experiment_type == 'homogeneous' and dimension == 3:
        lbda = minimum_mesh_velocity/frequency
        pad = lbda
        Lz = 15*lbda#100*lbda
        Real_Lz = Lz+ pad
    ...
    if receiver_type == 'near' and experiment_type == 'homogeneous' and dimension == 3:
