...
def value_parameter_error(par_name, par_value, valid_values):
    ...
    opt_str = (
        opt_str[:last_comma] + " or" + opt_str[last_comma + 1 :]  # noqa: E203
