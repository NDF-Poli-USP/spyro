...
class Acquisition:
    ...
    source_locations: np.array # can this be null?
    ...
    def __post_init__(self):
        ...
        if self.source_frequency < 1.0:
            warnings.warn(f"Frequency of {self.source_frequency} too low for realistic FWI.")
        elif self.source_frequency > 50:
            warnings.warn(f"Frequency of {self.source_frequency} too high for efficient FWI.")
