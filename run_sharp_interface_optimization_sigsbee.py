...
model["mesh"] = {
    ...
    "meshfile": "meshes/sigsbee2b_guess.msh",
    "initmodel": "velocity_models/sigsbee2b_guess.hdf5",
    "truemodel": "velocity_models/sigsbee2b_true.hdf5",
    "background": "velocity_models/sigsbee2b_true_background.hdf5",
}
model["PML"] = {
...
sources = spyro.create_transect((-0.01, 3.33), (-0.01, 19.4896), 3)
model["acquisition"] = {
    "source_type": "Ricker",
...
VP_1 = 4.4  # inside subdomain to be optimized
#### end of options ####
...
def optimization(
    ...
    while iter_num < max_iter:
        ...
        indicator_new = model_update(mesh, indicator, theta, beta0, timesteps=timesteps)
