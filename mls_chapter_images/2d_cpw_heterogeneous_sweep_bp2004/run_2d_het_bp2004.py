...
def test_cpw_calc():
    grid_point_calculator_parameters = {
        ...
        "velocity_model_file_name": "/media/olender/T7 Shield/common_files/velocity_models/vp_marmousi-ii.segy",
        "length_z": 12000.0/1000,
        "length_x": 67000.0/1000,
        ...
        "C_initial": 2.29,  # Initial G for line search (float)
    ...
    min = Cpw_calc.find_minimum(savetxt=False)
