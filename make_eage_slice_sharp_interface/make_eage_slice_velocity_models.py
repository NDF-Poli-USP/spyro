...
print(np.amin(vp_as_np_array))
print(np.amax(vp_as_np_array))
print(vp_as_np_array.shape)

y = np.linspace(0, 13520.0, 676)
z = np.linspace(-4200.0, 0.0, 210)
yg, zg = np.meshgrid(y, z)
true_slice = vp_as_np_array[:, :, 300]
true_slice[true_slice < 4400.0] = 2000.0

plt.pcolor(y, z, true_slice)
...
_create_segy(true_slice.T, "eage_slice_true.segy")
