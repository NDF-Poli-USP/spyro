...
dictionary["options"] = {
    ...
    "units": "meter",  # meter or kilometer 
}
...
dictionary["acquisition"] = {
    "source_type": "ricker",
    "source_locations": [(-0.55, 0.7), (-0.55, 1.0), (-0.55, 1.3)],
    "frequency": 5.0,
    "delay": 0.2,
    "delay_type": "time",
    "amplitude": 1,  # the Ricker has an amplitude of 1.
    "receiver_locations": spyro.create_transect((-1.45, 0.7), (-1.45, 1.3), 200), #  or list of lists
}
...
def run_fwi(load_real_shot=False, use_rol=False):
    """
    ...
    print(f"Outside box looks masked: {test0}", flush=True)
