...
#SBATCH --job-name=amd_strong_scalling/amd_test6_ico_2_node
...
mpiexec -n 60 python ico_benchmark_forward_3d.py 100
mpiexec -n 40 python ico_benchmark_forward_3d.py 100
mpiexec -n 35 python ico_benchmark_forward_3d.py 100
mpiexec -n 30 python ico_benchmark_forward_3d.py 100
