...
analytical_files =[
    # "plus1_analytical_solution_dt_5e-05.npy",
    # "plus1_analytical_solution_dt_0.0001.npy",
    "plus1_analytical_solution_dt_0.0005.npy",
]
numerical_files = [
    # "plus1_rec_out5e-05.npy",
    # "plus1_rec_out0.0001.npy",
    "plus1_rec_out0.0005.npy",
]
...
for i in range(len(analytical_files)):
    ...
    time = np.linspace(0.0, 1.0, len(p_numerical))
    dts.append(time[1] - time[0])
    nt = len(time)
