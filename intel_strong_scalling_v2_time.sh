...
#SBATCH --job-name=intel_strong_scalling_presentation/test2_5s
...
mpiexec -n 80 python benchmark_forward_3d_time.py 100
mpiexec -n 60 python benchmark_forward_3d_time.py 100
mpiexec -n 40 python benchmark_forward_3d_time.py 100
mpiexec -n 20 python benchmark_forward_3d_time.py 100
mpiexec -n 10 python benchmark_forward_3d_time.py 100
