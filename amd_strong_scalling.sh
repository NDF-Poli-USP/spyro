...
#SBATCH --job-name=amd_strong_scalling/test1
...
mpiexec -n 40 python benchmark_3d.py
mpiexec -n 30 python benchmark_3d.py
mpiexec -n 20 python benchmark_3d.py
mpiexec -n 15 python benchmark_3d.py
mpiexec -n 10 python benchmark_3d.py
mpiexec -n  5 python benchmark_3d.py
