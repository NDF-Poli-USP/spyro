...
#SBATCH --job-name=amd_strong_scalling/intel_test1_sh
...
mpiexec -n 35 python benchmark_3d_overthrust.py
mpiexec -n 30 python benchmark_3d_overthrust.py
mpiexec -n 20 python benchmark_3d_overthrust.py
mpiexec -n 25 python benchmark_3d_overthrust.py
...
mpiexec -n 50 python benchmark_3d_overthrust.py
mpiexec -n 55 python benchmark_3d_overthrust.py
