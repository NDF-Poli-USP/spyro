...
mesh_proj = fire.RectangleMesh(numz, numx, Ly, Lx)
mesh_proj.coordinates.dat.data[:, 0] *= -1.0
V_proj = fire.FunctionSpace(mesh_proj, 'CG', 1)
c_proj = fire.project(c, V_proj)
velocity = c_proj.dat.data[:]
