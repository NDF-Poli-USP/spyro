...
profile-clean:
	...
	@rm -rf $(PROFILERS_DIR)/*.pyisession $(PROFILERS_DIR)/cpu_profile_*.html $(PROFILERS_DIR)/memory_profile_*.png $(PROFILERS_DIR)/mprofile_*.dat 2>/dev/null || true
	@rm -rf mprofile_*.dat 2>/dev/null || true  # Also clean any mprof files in root
...
profile-help:
	...
	@echo "  make profile-cpu FILE=tests/on_one_core/test_pml.py"
	@echo ""
	@echo "  # Profile a specific test function"
	@echo "  make profile-cpu FILE=tests/on_one_core/test_pml.py FUNCTION=test_pml_2d"
	@echo ""
	@echo "  # Memory profile a specific test"
	@echo "  make profile-memory FILE=tests/on_one_core/test_pml.py FUNCTION=test_pml_2d"
	@echo ""
	@echo "  # Run both CPU and memory profiles"
	@echo "  make profile-all FILE=tests/on_one_core/test_pml.py"
	@echo ""
