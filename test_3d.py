...
def wave_dict(dt_usu, fr_files, layer_shape, degree_layer, degree_type,
              habc_ref_freq, get_ref_model, degree_eik):
    '''
    ...
    dictionary["absorving_boundary_conditions"] = {
        ...
        "degree_eikonal": degree_eik,  # Finite element order for the Eikonal
...
# SOU-3rd 150m 125m 100m  80m
# n_min    2.0  2.0
# n_max    3.6  3.8

# SOU-4th 150m 125m 100m  80m
# n_min    2.0  2.0
# n_max    3.2  3.2

# SOU-5th 150m 125m 100m  80m
# n_min    2.0  2.0
# n_max    3.2  3.2

# 1st               150m             125m
# 1.00 - 48.16% - 23.97% / 16.65% - 8.35%
# 1.10 - 50.03% - 21.77% / 14.75% - 6.84%
# 1.15 - 49.15% - 23.94%
# 1.16 - 50.37% - 23.94%

# 2nd               150m              125m
# 1.00 - 41.55% - 19.06% / 12.01% - 12.63%
# 1.10 - 41.87% - 19.06%
# 1.14 - 41.65% - 19.06%

# 3rd               150m              125m
# 1.00 - 21.44% - 12.35% / 12.01% - 12.63%
# 1.13 - 22.11% - 13.79%

# 4th               150m              125m
# 1.00 - 32.00% - 32.51% / 13.39% - 16.07%
# 1.10 - 32.00% - 32.51%
