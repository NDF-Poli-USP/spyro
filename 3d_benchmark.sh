...
#SBATCH --job-name=3d_test_case/3d_benchmark
...
mpiexec -n 5  python forward_3d.py
mpiexec -n 10 python forward_3d.py
mpiexec -n 15 python forward_3d.py
mpiexec -n 20 python forward_3d.py
mpiexec -n 30 python forward_3d.py
mpiexec -n 40 python forward_3d.py
mpiexec -n 60 python forward_3d.py
mpiexec -n 80 python forward_3d.py
mpiexec -n 100 python forward_3d.py
mpiexec -n 120 python forward_3d.py
