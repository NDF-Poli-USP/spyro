...
if MFUNC==3:
    ...
    if QUAD==1:
        file_name_uz = "uz_recv_QUAD_AMR_" + str(AMR) + "_MFUNC_" + str(MFUNC) + "_DGVP_" + str(DG_VP) + "_p_" + str(model["opts"]["degree"]) + "_h_" + str(h) + "m_freq_" + str(model["acquisition"]["frequency"])
        file_name_ux = "ux_recv_QUAD_AMR_" + str(AMR) + "_MFUNC_" + str(MFUNC) + "_DGVP_" + str(DG_VP) + "_p_" + str(model["opts"]["degree"]) + "_h_" + str(h) + "m_freq_" + str(model["acquisition"]["frequency"])
    else:
        file_name_uz = "uz_recv_AMR_" + str(AMR) + "_MFUNC_" + str(MFUNC) + "_DGVP_" + str(DG_VP) + "_p_" + str(model["opts"]["degree"]) + "_h_" + str(h) + "m_freq_" + str(model["acquisition"]["frequency"])
        file_name_ux = "ux_recv_AMR_" + str(AMR) + "_MFUNC_" + str(MFUNC) + "_DGVP_" + str(DG_VP) + "_p_" + str(model["opts"]["degree"]) + "_h_" + str(h) + "m_freq_" + str(model["acquisition"]["frequency"])
