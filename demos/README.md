...
It covers synthetic observations, a Taylor test, the joint inversion of
both velocities and an exercise inverting them in stages. We recommend the
latest Firedrake release.
