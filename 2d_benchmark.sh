...
#SBATCH --time=1:00:00
#SBATCH --job-name=2d_test_case/2d_benchmark
...
mpiexec -n 5 python strong_scalling_2d.py
mpiexec -n 10 python strong_scalling_2d.py
mpiexec -n 15 python strong_scalling_2d.py
mpiexec -n 20 python strong_scalling_2d.py
