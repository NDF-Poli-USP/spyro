...
def layer_2d():
    ...
    hl = HyperLayer((1.0, 1.0), n_hyp=2, dimension=2)
...
def layer_3d():
    ...
    hl = HyperLayer((1.0, 1.0, 1.0), n_hyp=2, dimension=3)
...
def test_init_custom():
    hl = HyperLayer((1.0, 1.0, 1.0), n_hyp=4, dimension=3)
...
def test_define_hyperlayer_clamps_n_hyp_up(layer_2d):
    layer_2d.n_hyp = 1.0  # below any valid n_min
    layer_2d.define_hyperlayer(pad_len=0.25, lmin=0.01)
