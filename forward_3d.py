...
model["mesh"] = {
    ...
    "initmodel": "/home/olender/common_files/velocity_models/overthrust_3D_guess_model.hdf5",
...
if comm.ensemble_comm.rank == 0:
    File("shots/true_velocity.pvd", comm=comm.comm).write(vp)
...
spyro.io.save_shots(model, comm, p_r,file_name="20shots/shot_")
